...
# Input
HEADERS += atom.h ctrl.h gui.h options.h paint.h safecalls.h sim.h status.h util.h world.h xsim.h
SOURCES += atom.c ctrl.cpp gui.cpp main.cpp options.cpp paint.cpp safecalls.cpp sim.cpp status.cpp world.c xsim.cpp ../SFMT/SFMT.c
